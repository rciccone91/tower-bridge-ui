...
const ClasesList  = () => {
    ...
    const getRequestParams = (searchNombre, searchCurso, searchProfesor, searchDia, page) => {
        let params = {};
    ...
    const retrieveClases = () => {
        const params = getRequestParams(searchNombre, searchCurso, searchProfesor, searchDia, page);
